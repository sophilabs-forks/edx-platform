...
REGISTRATION_FIELD_OVERRIDES = ENV_TOKENS.get('REGISTRATION_FIELD_OVERRIDES', REGISTRATION_FIELD_OVERRIDES)
REGISTRATION_EMAIL_PATTERNS_ALLOWED = ENV_TOKENS.get('REGISTRATION_EMAIL_PATTERNS_ALLOWED')
ACCOUNT_SETTINGS_EXTENSION_FIELDS = ENV_TOKENS.get('ACCOUNT_SETTINGS_EXTENSION_FIELDS', [])

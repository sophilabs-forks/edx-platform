...
def login_and_registration_form(request, initial_mode="login"):
    ...
    if not third_party_auth['currentProvider'] and configuration_helpers.get_value('ENABLE_EXCLUSIVE_SSO_LOGISTRATION', settings.APPSEMBLER_FEATURES['ENABLE_EXCLUSIVE_SSO_LOGISTRATION']):

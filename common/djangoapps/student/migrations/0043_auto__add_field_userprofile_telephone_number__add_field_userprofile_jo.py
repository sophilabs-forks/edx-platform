...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.job_role'
        db.add_column('auth_userprofile', 'job_role',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.job_role'
        db.delete_column('auth_userprofile', 'job_role')
    ...
    models = {
        ...
        'student.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'job_role': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
            ...
            'telephone_number': ('django.db.models.fields.CharField', [], {'max_length': '15', 'blank': 'True'}),
